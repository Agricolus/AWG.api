...
namespace FIWARESerialization.Tests.Standard.DeviceModel
{
  ...
  public class DeviceModel_JSON_Conversion_Tests
  {
    ...
    public void Deserialization_Serialization_EndToEnd()
    {
      ...
      AWG.FIWARE.DataModels.DeviceModel deviceModelDeserialized = JsonConvert.DeserializeObject<AWG.FIWARE.DataModels.DeviceModel>(exampleDeviceModelSerialized);
    ...
    public void Serialization_IsConformToSchema()
    {
      ...
      var deviceModelSerialized = JsonConvert.SerializeObject(device);
