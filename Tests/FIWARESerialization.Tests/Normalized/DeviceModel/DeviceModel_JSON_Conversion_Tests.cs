...
namespace FIWARESerialization.Tests.Normalized.DeviceModel
{
  // [TestClass]
  public class DeviceModel_JSON_Conversion_Tests
  {
    ...
    {
      string exampleDeviceModelSerialized = System.IO.File.ReadAllText(@"DeviceModel.example.normalized.json");
