...
namespace FIWARESerialization.Tests.Normalized.WeatherObserved
{
  [TestClass]
  public class WeatherObserved_JSON_Conversion_Tests
  {
    ...
    {
      string exampleWeatherObservedSerialized = System.IO.File.ReadAllText(@"WeatherObserved.example.normalized.json");
